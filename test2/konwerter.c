...
/* Komentarz */
/* Wersji c w napisie Latin2 pokazuja sie znaki zapytania w miejscu polskich znakow, a w napisie ASCII w miejsce polskich znakow pojawiaja sie litery */
/* zastepcze c, s, z, l. W wersji c++ w obydwu przypadkach sa znaki zapytania.*/
